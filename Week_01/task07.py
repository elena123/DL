...
if __name__ == '__main__':
    np_baseball = np.array(
        [[74.0, 180.0, 22.99], [74.0, 215.0, 34.69], [72.0, 210.0, 30.78], [72.0, 210.0, 35.43], [73.0, 188.0, 35.71],
    ...
    print("Average:", avg_height)
    print("Median:", median_height)
    print(":Standard Deviation:", std_height)
    print("Correlation:", correlation)

# Answer the question: Do big players tend to be heavier?. Yes. The  correlation is 0.53 and a correlation
# coefficient of plus 0.5 indicates a moderate positive correlation within a data set. This means that as one
# variable increases, the other tends to increase as well, but not as consistently as in a strong positive
# correlation (a correlation coefficient close to +1)
